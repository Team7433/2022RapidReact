...
OneBallAutoA::OneBallAutoA(Magazine * m_magazine, SwerveDriveTrain * m_swerve, Gyro * m_gyro, Vision * m_vision, DualShooter * m_dualshooter) {
 ...
 frc::Timer* m_timer = new frc::Timer;
  ...
  AddCommands(
    ...
    MotionProfile(m_swerve, m_gyro, coordinate{2.137_m, -0.654_m, -26.83_deg}),
