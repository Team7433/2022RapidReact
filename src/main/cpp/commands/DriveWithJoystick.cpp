...
void DriveWithJoystick::Execute() {
  ...
  if (fabs(rotate) < kJoystickRotateDeadZone) {
    rotate = 0;
  }
  ...
  m_swerveDriveTrain->Drive(forward*kForwardMultiplier, strafe*kStrafeMultiplier, rotate*kRotateMultiplier, true, true, true, false);
